...
Peerlist.prototype = new EventEmitter
Peerlist.prototype.constructor = Peerlist
...
Peerlist.prototype.inList = function(checkPeer) {
  ...
  if('string' == typeof checkPeer) return this.list.map(function(peer) {return peer.id == checkPeer})[0] || false
  return false
}